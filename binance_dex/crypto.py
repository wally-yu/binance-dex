...
class PublicKey(PublicKeyBase):
    ...
    def address(self, compressed=True):
        ...
        return 'tbnb' + encode_hex(self.keccak[12:])
...
# master_key, mnemonic = HDPrivateKey.master_key_from_entropy(strength=256)
#
# print('BIP32 Wallet Generated.' + str(key))
# print('Mnemonic Secret: ' + mnemonic)
#
mnemonic = 'exercise era siege direct pen school utility auction wrestle turkey echo buffalo dinner crumble cereal path issue siren forum dose amused gospel net rural'
# master_key = HDPrivateKey.master_key_from_mnemonic(mnemonic)
# # print(master_key.to_hex())
# root_keys = HDKey.from_path(master_key, "44'/714'/0'/0/0")
#
...
pubkey_hash160 = acct_pub_key.hash160()

hashed = codecs.encode(pubkey_hash160, 'hex_codec').decode('ascii')
converted = convertbits(pubkey_hash160, 8, 5, True)
print("address_python: " + bech32_encode('tbnb', converted))

# print(codecs.encode(pubkey_hash160, 'hex_codec').decode('ascii'))

# print(codecs.encode(acct_pub_key.compressed_bytes, 'hex_codec').decode('ascii'))
print('pri_key_python: ' + acct_priv_key._key.to_hex())
